...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">  
  ...
  <% 
    ...
    String url = "xueyeguihuazhishilist.jsp?2=2"; 
  ...
  <tr>
    ...
    <td><%=map.get("biaoti") %></td><td><%=map.get("zhuanye") %></td><td><%=map.get("leibie") %></td><td><a class="btn btn-info btn-small" href='<%=map.get("fujian") %>' target='_blank'>下载</a></td>
    
    <td width="50" align="center"> <a class="btn btn-info btn-small" href="xueyeguihuazhishidetail.jsp?id=<%=map.get("id")%>" >详细</a></td>
  </tr>
  	<%
  }
   %>
