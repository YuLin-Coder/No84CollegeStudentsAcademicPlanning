...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc">  
  ...
  <tr>
    ...
    <td width="60" align="center"><a class="btn btn-info btn-small" href='yuyuefuwu_add.jsp?id=<%=map.get("id")%>'>添加预约服务</a> <a class="btn btn-info btn-small" href="fuwuxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
