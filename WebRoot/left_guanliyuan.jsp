...
<dl class="custom">
			...
			<dd><a href="xueshengxinxi_list.jsp" target="hsgmain">学生查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">服务管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="fuwuxinxi_add.jsp" target="hsgmain">服务添加</a></dd><dd><a href="fuwuxinxi_list.jsp" target="hsgmain">服务查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">预约服务管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="yuyuefuwu_list.jsp" target="hsgmain">预约服务查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">学业规划知识管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="xueyeguihuazhishi_add.jsp" target="hsgmain">学业规划知识添加</a></dd><dd><a href="xueyeguihuazhishi_list.jsp" target="hsgmain">学业规划知识查询</a></dd>
		</dl><dl class="custom">
